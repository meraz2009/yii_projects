...
class LogInUserInfoController extends Controller
{
	 ...
	 * @return LogInUserInfo the loaded model
	 * @throws CHttpException
	 */
	public function loadModel($id)
	{
		$model=LogInUserInfo::model()->findByPk($id);
		if($model===null)
	 ...
	 * @param LogInUserInfo $model the model to be validated
	 */
	protected function performAjaxValidation($model)
	{
		if(isset($_POST['ajax']) && $_POST['ajax']==='log-in-user-info-form')
		{
