...
<div class="form">
	...
	<div class="row">
		...
		<?php echo $form->passwordField($model,'pwd_hash',array('size'=>20,'maxlength'=>64)); ?>
...
<!--<img src="<?php /*echo yii::app()->basePath*/?>/images/user_image/index.jpeg">-->

<!--<img src="/images/user_image/index.jpeg" />-->
